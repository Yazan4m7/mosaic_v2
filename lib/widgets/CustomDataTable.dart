...
/// in the [DataTable], in the [new CustomDataRow] constructor's `cells`
/// argument.
@immutable
...
///   return DataTable(
///     columns: const <CustomDataColumn>[
///       CustomDataColumn(
///         label: Text(
///           'Name',
...
///       ),
///     ],
///     rows: const <CustomDataRow>[
///       CustomDataRow(
///         cells: <CustomDataCell>[
///           CustomDataCell(Text('Sarah')),
///           CustomDataCell(Text('19')),
///           CustomDataCell(Text('Student')),
///         ],
///       ),
///       CustomDataRow(
///         cells: <CustomDataCell>[
///           CustomDataCell(Text('Janine')),
///           CustomDataCell(Text('43')),
///           CustomDataCell(Text('Professor')),
///         ],
///       ),
///       CustomDataRow(
///         cells: <CustomDataCell>[
///           CustomDataCell(Text('William')),
///           CustomDataCell(Text('27')),
///           CustomDataCell(Text('Associate Professor')),
///         ],
///       ),
///     ],
///   );
...
this.onSelectAll,
this.CustomDataRowHeight = 50,
this.headingRowHeight = 56.0,
this.horizontalMargin = 18.0,
this.columnSpacing = 38.0,
...
///
/// If this is null, then the [CustomCustomDataRow.onSelectChanged] callback of
/// every row in the table is invoked appropriately instead.
///
/// To control whether a particular row is selectable or not, see
/// [CustomCustomDataRow.onSelectChanged]. This callback is only relevant if any
/// row is selectable.
...
tableRows[rowIndex].children[displayColumnIndex] = _buildCustomDataCell(
context: context,
padding: padding,
label: cell.child,
numeric: column.numeric,
